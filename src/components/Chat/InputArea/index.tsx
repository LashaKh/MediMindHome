          ...
          <div className="flex w-full gap-2 items-end">
            <div className="flex-1 relative">
              <textarea
                ...
                rows={2}
                disabled={disabled}
                className="w-full resize-none rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 focus:outline-none focus:ring-2 focus:ring-primary dark:text-white disabled:opacity-50"
                style={{ minHeight: "60px" }}
              />
            </div>

            <div className="flex-shrink-0 flex items-center gap-2 pb-1">
              <label className="p-2 sm:px-3 sm:py-2 cursor-pointer bg-primary/10 text-primary hover:bg-primary/20 dark:bg-primary/20 dark:text-blue-300 dark:hover:bg-primary/30 rounded-lg transition-colors flex items-center gap-2">
                <input
                  type="file"
                  ref={fileInputRef}
                  accept="image/*"
