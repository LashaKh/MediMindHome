...
export const PatientDetails: React.FC = () => {
  ...
  const { patients, updatePatient, addNote, loadPatients, loading, error: patientError } = usePatientStore();
    ...
    try {
      ...
      try {
        ...
        if (error instanceof Error && error.message.includes('not found')) {
          ...
          navigate('/patients'); // Navigate away since patient doesn't exist
        } else {
          throw error;
        }
      }
  ...
  // Rest of the component code remains the same as PatientDetailsModal
  // Just remove the modal-specific wrapper and animation code
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gray-50 dark:bg-gray-900">
      ...
      {/* Rest of the component JSX remains the same as PatientDetailsModal */}
      {/* Just remove the modal wrapper and animation code */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div ref={patientInfoRef} className="space-y-6">
          ...
          <div ref={comorbidityRef} className="py-6 border-t dark:border-gray-700">
          ...
          <div ref={notesRef} className="py-6 border-t dark:border-gray-700">
            <NotesSection 
