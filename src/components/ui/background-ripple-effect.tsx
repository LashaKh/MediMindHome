  ...
  return (
    ...
    >
      <div className="absolute h-[26rem] inset-y-0 overflow-hidden">
        ...
        >
          <Pattern cellClassName="border-accent relative z-[100]" />
        </div>
        <Pattern className="opacity-[0.3] dark:opacity-[0.5]" cellClassName="border-gray-300 dark:border-gray-600" />
      </div>
    </div>
  );
};
          ...
          {row.map((column, colIdx) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "bg-transparent border-l border-b border-gray-300 dark:border-gray-600",
                  cellClassName
                )}
              ...
              >
                <motion.div
                  ...
                  animate={controls}
                  className="bg-accent/30 dark:bg-accent/40 h-12 w-12"
                />
              </div>
            );
          })}
