/*
  # Copy assigned patients to personal tracking
  
  1. New Function
    - Creates a function to copy assigned patients to personal_patients table
    - Only copies patients where user is the assigned doctor
    - Preserves essential patient data
    
  2. Data Migration
    - Automatically copies existing assigned patients
...
BEGIN
  ...
  SELECT 
    gen_random_uuid(), -- Generate new ID for personal tracking
