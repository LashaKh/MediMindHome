-- Add admission_date column to personal_patients table
...
CREATE INDEX IF NOT EXISTS idx_personal_patients_admission_date 
ON personal_patients(admission_date);
