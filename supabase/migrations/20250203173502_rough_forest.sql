-- Add comorbidities column to patients table
ALTER TABLE patients
ADD COLUMN IF NOT EXISTS comorbidities text[] DEFAULT ARRAY[]::text[];

-- Create index for comorbidities
CREATE INDEX IF NOT EXISTS idx_patients_comorbidities ON patients USING gin(comorbidities);

-- Update copy function to handle comorbidities
